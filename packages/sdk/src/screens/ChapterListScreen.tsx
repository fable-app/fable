/**
 * ChapterListScreen
 * Screen showing chapters for multi-chapter books
...
type NavigationProp = StackNavigationProp<RootStackParamList, 'ChapterList'>;
type RoutePropType = RouteProp<RootStackParamList, 'ChapterList'>;
...
export function ChapterListScreen() {
  ...
  const handleChapterPress = (chapterId: string) => {
    navigation.navigate('Reader', { storyId: chapterId });
  };
